# 05_play_black.py — version simplifiée (Option 2)
...
WORKFLOW_FILENAME = "run_bot.yml"              # nom du workflow GitHub
GITHUB_TOKEN = os.getenv("GH_WORKFLOW_TOKEN")  # PAT avec scope 'workflow'
...
def fetch_fen_from_pgn(game_id):
    """Récupère la position depuis le PGN brut"""
...
def trigger_bot_workflow(game_id: str, elo: str = "1500"):
    """Déclenche le workflow run_bot.yml par nom de fichier"""
    if not GITHUB_TOKEN:
